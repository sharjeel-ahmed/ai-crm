...
const navItems = [
  ...
  { to: '/ai-inbox', icon: Sparkles, label: 'AI Inbox' },
  { to: '/ai-logs', icon: ScrollText, label: 'AI Logs' },
...
export default function Sidebar() {
  ...
  return (
    <aside className={`${collapsed ? 'w-16' : 'w-64'} bg-gray-900 text-white flex flex-col min-h-screen transition-all duration-200`}>
